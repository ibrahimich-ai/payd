...
<aside class="sidebar">
  ...
  <nav class="sb-nav">
    ...
    <a class="sb-link" data-page="inbox" href="inbox.html">
      ...
      Inbox · Чаты
      <span class="badge" data-count="inbox">0</span>
    </a>
...
const TAB_PAGE_ICONS = {
  ...
  inbox:        '<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="22 12 16 12 14 15 10 15 8 12 2 12"/><path d="M5.45 5.11L2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z"/></svg>'
};
